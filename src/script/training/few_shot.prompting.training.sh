...
for model_name_or_config_path in "roberta-base" "roberta-large"; do
  for pre_seq_len in 10 15 20; do
    for task in "SST-2" "cr" "RTE" "mr"; do
      for seed in "13" "21" "42" "87" "100"; do
        ...
        checkpoint_path="../checkpoints/finetuning/${model_name_or_config_path}/prompting/pre_seq_len${pre_seq_len}/${task}/16-${seed}"
